...
- 通道费 pass-through：**乘客充值 100 CNY，到账 95 积分**（1 CNY = 1 积分基准；`00.3` 定义）
- `wallet_ledger` 记**两笔**：`recharge +95` 和 `channel_fee −5`（−5 仅明细留痕，不重复扣 balance）
