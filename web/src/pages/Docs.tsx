...
const FIELD_GROUPS: FieldGroup[] = [
  ...
  // ── 车级策略 ─────────────────────────────
  {
    ...
    rows: [
      { code: "auto_refill_enabled", type: "bool?",   required: false, notes: "null=跟随全局默认(§4.3.2) · true/false=覆盖本车" },
      { code: "refill_watermark",    type: "int?",    required: false, notes: "紧急线 · 车里剩几个号触发补车 · null=跟随全局" },
      ...
      { code: "daily_round_limit",   type: "int?",    required: false, notes: "本车每日轮数上限 · null=跟随全局" },
      { code: "daily_spend_limit",   type: "int64?",  required: false, notes: "microunit · 本车每日消费上限 · null=跟随全局" },
